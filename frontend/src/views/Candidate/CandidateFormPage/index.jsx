...
export default function PublicFormPage() {
  ...
  if (error)
    return <Alert message={error} type="error" className="error-alert" />;

  return (
    <div className="public-form-page">
      <div className="container">
        <h1 className="page-title">
          {formConfig?.job?.jobTitle || "Job Application"}
        </h1>
                ...
                {formConfig?.job ? (
                  <Descriptions column={1} bordered>
                    ...
                    <Descriptions.Item label="Job Location">
                      {formConfig.job.location?.charAt(0).toUpperCase() +
                        formConfig.job.location?.slice(1) || "N/A"}
                    </Descriptions.Item>
                    ...
                    <Descriptions.Item label="Application Period">
                      {formConfig.job.activeDuration?.startDate &&
            ...
            message={
              ...
              >
                <div>
                  ...
                  <span>The job is currently in active.</span>
                </div>
