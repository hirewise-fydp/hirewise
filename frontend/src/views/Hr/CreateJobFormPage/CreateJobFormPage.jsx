...
const CreateJobFormPage = () => {
  ...
  const calculateRemainingWeightage = (values) => {
    const standardParams = ["skills", "experience", "education", "certifications"]
    let used = 0
  ...
  const onFinish = async (values) => {
    ...
    const totalUsed = Object.values(evaluationConfig).reduce((sum, val) => sum + val, 0)
    if (totalUsed !== 100) {
      message.error(`Total weightage must equal 100%. Current total: ${totalUsed}%`)
      return
    }
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Row gutter={16}>
                    <Col span={24}>
                      ...
                      >
                        <Input placeholder="Enter the job title" size="large" style={{ borderRadius: "6px" }} />
                      </Form.Item>
                    </Col>
                  </Row>
                  ...
                  <Row gutter={16}>
                    <Col span={24}>
                      <Form.Item label="Job Description (Optional)" name="description">
                        <Input.TextArea
                  ...
                  <Row gutter={16}>
                    <Col span={24}>
                      <Form.Item
                        ...
                        rules={[{ required: true, message: "Please upload a job description file!" }]}
                      >
                        <Upload
                          beforeUpload={() => false}
                          maxCount={1}
                ...
                <Panel
                  header={
                    <Space>
                      ...
                      <Tag
                        color={remainingWeightage === 0 ? "success" : remainingWeightage < 0 ? "error" : "processing"}
                ...
                >
                  <div style={{ marginBottom: "24px" }}>
                    <Paragraph>
                      Set weightage for different parameters to evaluate candidates. Total must equal 100%.
                    </Paragraph>
                  ...
                  <Row gutter={[24, 24]}>
                    <Col xs={24} sm={12}>
                      <Card
                        ...
                        extra={<Text type="secondary">{formValues.weightage_skills}%</Text>}
                        style={{ borderRadius: "8px" }}
                      >
                        <Tooltip title="Technical skills, soft skills, etc.">
                          <Paragraph type="secondary" style={{ marginBottom: "16px" }}>
                            Evaluate candidates based on their technical and soft skills
                          </Paragraph>
                        </Tooltip>
                    ...
                    <Col xs={24} sm={12}>
                      <Card
                        ...
                        extra={<Text type="secondary">{formValues.weightage_experience}%</Text>}
                        style={{ borderRadius: "8px" }}
                      >
                        <Tooltip title="Work history, relevant experience, etc.">
                          <Paragraph type="secondary" style={{ marginBottom: "16px" }}>
                            Evaluate candidates based on their work history and relevant experience
                          </Paragraph>
                        </Tooltip>
                    ...
                    <Col xs={24} sm={12}>
                      <Card
                        ...
                        extra={<Text type="secondary">{formValues.weightage_education}%</Text>}
                        style={{ borderRadius: "8px" }}
                      >
                        <Tooltip title="Degrees, academic achievements, etc.">
                          <Paragraph type="secondary" style={{ marginBottom: "16px" }}>
                            Evaluate candidates based on their educational background and academic achievements
                          </Paragraph>
                        </Tooltip>
                    ...
                    <Col xs={24} sm={12}>
                      <Card
                        ...
                        extra={<Text type="secondary">{formValues.weightage_certifications}%</Text>}
                        style={{ borderRadius: "8px" }}
                      >
                        <Tooltip title="Professional certifications, courses, etc.">
                          <Paragraph type="secondary" style={{ marginBottom: "16px" }}>
                            Evaluate candidates based on their professional certifications and completed courses
                          </Paragraph>
                        </Tooltip>
                    ...
                    {customParameters.map((param) => (
                      <Col xs={24} sm={12} key={param}>
                        <Card
                          ...
                          extra={<Text type="secondary">{formValues[`weightage_${param}`] || 0}%</Text>}
                          style={{ borderRadius: "8px" }}
                        >
                          <Paragraph type="secondary" style={{ marginBottom: "16px" }}>
                            Custom evaluation parameter
                          </Paragraph>
                          <Form.Item name={`weightage_${param}`} noStyle initialValue={0}>
                            <Slider
                              min={0}
                              max={100}
                              marks={{ 0: "0%", 50: "50%", 100: "100%" }}
              ...
              <Form.Item style={{ marginTop: "32px" }}>
                ...
                >
                  {remainingWeightage !== 0
                    ? `Adjust Weightage (${remainingWeightage > 0 ? `${remainingWeightage}% Remaining` : `${Math.abs(remainingWeightage)}% Over`})`
                    : "Create Job"}
                </Button>
              </Form.Item>
            </Form>
